Public Class Pos
    ...
    Private Sub txtbxItems_Keyup(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtbxItems.KeyUp
        ...
        If txtbxItems.Text = "" Then
            lstbxItems.Visible = False
        Else
            listitemname = obj.getdatatable("select top 1 'Add New' as item_name,'0' as item_no from item_tbl union select item_name,item_no from item_tbl where item_name like '%" + txtbxItems.Text + "%' and item_type='Goods'")
    ...
    Private Sub lstbxItems_MouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles lstbxItems.MouseClick
        lstbxItems.Visible = False
        If lstbxItems.Text = "Add New" Then
            Items.Show()
            Items.BringToFront()
            Items.Focus()
        Else
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        Try
            ...
            itemdatatable.Rows.Add(Me.txtbxItems.Text, lstbxItems.SelectedValue,
    ...
    Private Sub CalculationArea()
        ...
        cussave = 0
        For i = 0 To gridItems.Rows.Count - 1
            mrprate = obj.GetOneValueFromQuery("select mrp from item_tbl where item_no='" + gridItems.Rows(i).Cells(1).Value.ToString() + "'")
...
"," & item_amount & "," & cess_amt & "," & tax_amt & "," & disc_amt & ")")
        ...
        QueryCollection.Add("insert into voucher_tbl (voucher_no,voucher_user_no	,voucher_dt,voucher_type," & _
                      ...
                      "notes,	company_id,	user_name) values('" + voucher_no + "','" + voucher_user_no + "'," & _
...
"	grand_total,	cash_recieved,	customer_savings,	company_id,	user_name) values( " & _
        ...
        Select Case result
            Case True
                MsgBox("POS details updated!!", MessageBoxIcon.Information)
    ...
    Private Sub txtbxItems_Keyup(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtbxItems.KeyUp
    ...
    Private Sub btnClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClear.Click
        ...
        S.SetPOSReportInvoiceno("DAR/INV/3")
        POSReportScreen.Show()
        POSReportScreen.BringToFront()
        POSReportScreen.TopMost = True
    End Sub
