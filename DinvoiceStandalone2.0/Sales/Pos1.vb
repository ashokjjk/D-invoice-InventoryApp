Public Class Pos
    ...
    Private Sub txtbxitems_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtbxitems.Enter
    ...
    '    txtbxitems.AutoCompleteMode = AutoCompleteMode.SuggestAppend ' This is necessary
    '    txtbxitems.AutoCompleteSource = AutoCompleteSource.ListItems
    '    'lstbxitems.DroppedDown = True
    ...
    '  Private Sub lstbxitems_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtbxitems.KeyDown
    'If e.KeyCode = Keys.Enter Then
    '    Me.lblbarcode.Text = Me.lstbxitems.Text
    '    Select Case obj.FindDuplicate("select count(*) from item_tbl where barcode_no='" + Me.lblbarcode.Text + "'")
    '        Case Is >= 1
    '            Dim itemdata As New List(Of String)
    '            itemdata = obj.GetMoreValueFromQuery("select uom,sale_rate,cess,igst,item_name from item_tbl where barcode_no='" + Me.lstbxitems.Text + "'", 5)
    '            cmbUom.Text = itemdata(0)
    '            txtRate.Text = itemdata(1)
    '            txtCess.Text = itemdata(2)
    '            cmbItemTax.Text = itemdata(3)
    ...
    '    End Select
    'End If
    'If e.KeyCode = Keys.Up Or e.KeyCode = Keys.Down Or e.KeyCode = Keys.Enter Or e.KeyCode = Keys.Back Then
    'Else
    '    itemload()
    'End If
...
"	grand_total,	cash_recieved,	customer_savings,	company_id,	user_name,voucher_no) values( " & _
    ...
    Private Sub txtbxItems_Keyup(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
